...
Route::middleware('auth')->group(function () {
    ...
    // === Route image & upload == //
    Route::get('/dashboard',[ImageController::class, 'index'])->name('image');
    Route::get('/upload', [UploadController::class, 'index'])->name('upload');
    Route::post('/upload', [UploadController::class, 'store']);
    Route::delete('dashboard/{fotoID}', [ImageController::class, 'delete'])->name('dataImage.delete');
    Route::get('detailImageEdit/{fotoID}/{id}', [ImageController::class, 'edit'])->name('edit');
    Route::post('dashboard/{fotoID}', [ImageController::class, 'update'])->name('dataImage.update');
    // === Route profile == //
